 ...
 * StateMachineBot. The class provides all the configuration needed by the bot.
 * 
 * @author rabidgremlin.
 *
 */
public interface StateMachineBotConfiguration
{
   ...
   * will be used by the bot to determine what a user said to the bot.
   * 
  ...
  /**
   * This method should create the StateMachine used by the bot to track the state
