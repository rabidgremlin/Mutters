...
/**
 * This class holds the details of an attachment to a response. Attachments can be used to return rich media info or
 * other meta data for each bot response.
 * 
 * Each attachment must have a type and optionally can have one or more parameters.
 * 
 * @author rabidgremlin
 *
 */
