...
/**
 * A Slot that is a combination of two other slots. Useful if you need different approaches for matching a slot. Class
 * will stop on the match returned by a slot.
 * 
 * @author rabidgremlin
 *
 */
public class CompoundSlot
    extends Slot
{
